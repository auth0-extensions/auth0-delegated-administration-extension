...
- Support for prepopulating user search from URL parameters (`search` and `filterBy`), enabling deep-linking to filtered user searches from external systems
- Client-side validation of URL-supplied search queries and filter fields, including Lucene syntax validation
