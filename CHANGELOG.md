...
- Updated package versions for ejs-template and form-data to fix vulnerabilities

## [5.0.3] - 2026-09-14

- replaced and updated various vulnerable dependencies
...
- Resolved an issue introduced in 5.0.0. (See https://github.com/auth0-extensions/auth0-delegated-administration-extension/issues/442)

## [5.0.0] - 2026-08-10

### Changed

- Upgraded React to v18 along with the related frontend stack (React Router, React Redux, Redux Form, and supporting build tooling).

### Note

- Some CSS styles may have changed as part of the upgrade. Customers using custom CSS should test their styles to ensure they still render as expected.
