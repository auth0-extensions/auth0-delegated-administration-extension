...
export default class UserForm extends Component {
    ...
    render() {
        ...
        return <div className="row">
            <form className="createUserScreenForm form-horizontal col-xs-12" style={{marginTop: '40px'}} onSubmit={function (e) {
                e.preventDefault();
                ...
                <div className="form-group row">
                    ...
                    <div className="col-xs-9">
                        <select className="form-control" name="connection" onChange={this.onConnectionChange.bind(this)}>
