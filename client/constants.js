...
// Remove user blocks.
export const REQUEST_REMOVE_BLOCKS = 'REQUEST_REMOVE_BLOCKS';
export const CANCEL_REMOVE_BLOCKS = 'CANCEL_REMOVE_BLOCKS';
export const REMOVE_BLOCKS = 'REMOVE_BLOCKS';
export const REMOVE_BLOCKS_PENDING = 'REMOVE_BLOCKS_PENDING';
export const REMOVE_BLOCKS_REJECTED = 'REMOVE_BLOCKS_REJECTED';
export const REMOVE_BLOCKS_FULFILLED = 'REMOVE_BLOCKS_FULFILLED';
